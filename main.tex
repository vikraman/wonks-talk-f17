...
\startslide[title={Soundness \& Completeness}]
  ...
  \startalignment[middle]
    \dontleavehmode
    \startMPcode
      drawarrow (5,5)..(50,25)..(95,5);
      drawarrow (95,-5)..(50,-25)..(5,-5);
      draw (btex {\tt{Syn}} etex) shifted (-20,-3);
      draw (btex {\tt{Con}} etex) shifted (40,30);
      draw (btex {\tt{Mod}} etex) shifted (100,-3);
      draw (btex {\tt{Lan}} etex) shifted (40,-38);
      draw (btex {\ttbfc{⊥}} etex) shifted (38,-5);
    \stopMPcode
  \stopalignment
